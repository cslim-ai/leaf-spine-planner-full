...
const REPORT_FONT_URL = "fonts/Pretendard-Regular.ttf";
...
async function getReportFontDataUrls() {
  ...
  const [thin, extraLight, light, regular, medium, semiBold, bold, extraBold, black] = await Promise.all([
    fetchReportFontDataUrl("fonts/Pretendard-Thin.ttf"),
    fetchReportFontDataUrl("fonts/Pretendard-ExtraLight.ttf"),
    fetchReportFontDataUrl("fonts/Pretendard-Light.ttf"),
    fetchReportFontDataUrl(REPORT_FONT_URL),
    fetchReportFontDataUrl("fonts/Pretendard-Medium.ttf"),
    fetchReportFontDataUrl("fonts/Pretendard-SemiBold.ttf"),
    fetchReportFontDataUrl("fonts/Pretendard-Bold.ttf"),
    fetchReportFontDataUrl("fonts/Pretendard-ExtraBold.ttf"),
    fetchReportFontDataUrl("fonts/Pretendard-Black.ttf"),
  ]);
